...
QUEUE_ITEMS = [
    ...
    {
        "name": "rerun8_architecture_without_generative_from_scratch_unfrozen_adamw",
        "use_imagenet_weights": False,
        "unfreeze_base": True,
        "experiment_specs_path": "experiment_suites/architecture_without_generative.json",
        "output_suffix": "rerun8_architecture_without_generative_from_scratch_unfrozen_adamw",
        "summary_name": "all_experiments_summary_rerun8_architecture_without_generative_from_scratch_unfrozen_adamw.json",
        "batch_size": 32,
        "epochs": 300,
        "learning_rate": 3e-4,
        "early_stopping_patience": 50,
    ...
    {
        "name": "rerun9_architecture_with_generative_from_scratch_unfrozen_adamw",
        "use_imagenet_weights": False,
        "unfreeze_base": True,
        "experiment_specs_path": "experiment_suites/architecture_with_generative.json",
        "output_suffix": "rerun9_architecture_with_generative_from_scratch_unfrozen_adamw",
        "summary_name": "all_experiments_summary_rerun9_architecture_with_generative_from_scratch_unfrozen_adamw.json",
        "batch_size": 32,
        "epochs": 300,
        "learning_rate": 3e-4,
        "early_stopping_patience": 50,
    ...
    {
        "name": "rerun10_architecture_mix_5to1_from_scratch_unfrozen_adamw",
        "use_imagenet_weights": False,
        "unfreeze_base": True,
        "experiment_specs_path": "experiment_suites/architecture_with_generative_mix_5to1.json",
        "output_suffix": "rerun10_architecture_mix_5to1_from_scratch_unfrozen_adamw",
        "summary_name": "all_experiments_summary_rerun10_architecture_mix_5to1_from_scratch_unfrozen_adamw.json",
        "batch_size": 32,
        "epochs": 300,
        "learning_rate": 3e-4,
        "early_stopping_patience": 50,
    ...
    {
        "name": "rerun11_architecture_mix_2to1_from_scratch_unfrozen_adamw",
        "use_imagenet_weights": False,
        "unfreeze_base": True,
        "experiment_specs_path": "experiment_suites/architecture_with_generative_mix_2to1.json",
        "output_suffix": "rerun11_architecture_mix_2to1_from_scratch_unfrozen_adamw",
        "summary_name": "all_experiments_summary_rerun11_architecture_mix_2to1_from_scratch_unfrozen_adamw.json",
        "batch_size": 32,
        "epochs": 300,
        "learning_rate": 3e-4,
        "early_stopping_patience": 50,
